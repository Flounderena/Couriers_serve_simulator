...
{
public:
    Dispatcher(int off, int cour, int st) : num_of_offices(off), num_of_couriers(cour), step(st), num_free_rides(0), sum_of_deviations(0), letters_cnt(0) {
...
private:
	...
	int num_free_rides, sum_of_deviations, letters_cnt;
