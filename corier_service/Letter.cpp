...
void Letter::set_t_begin(int t) {
	t_begin = t;
}

void Letter::set_t_end(int t) {
	t_end = t;
}
...
int Letter::get_t_end() {
	return t_end;
}

int Letter::get_beg_of() {
	return from_of;
}

int Letter::get_end_of() {
	return to_of;
}

int Letter::get_order_time() {
	return order_time;
}

int Letter::get_deadline() {
	return deadline;
}
